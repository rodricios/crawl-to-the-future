...
<script type="text/javascript">archive_analytics.values.server_name="wwwb-app2.us.archive.org";archive_analytics.values.server_ms=1850;</script>
...
<SCRIPT language=javascript src=../Support/hdr35.js?v=2 type=text/javascript></SCRIPT>				
		...
		<script>function TellMeMore(){self.location = '/web/20051031232728/http://g.msn.com/8SEENUS020100/SuiteHomeBdy_results'};</script>
		<SCRIPT>function OpenSys(){window.open('/web/20051031232728/http://g.msn.com/8SEENUS020100/TBarHome_MoreSysReq','','height=570,width=385,toolbar=0,status=0,menubar=0,resizable=0,top=0');}</SCRIPT>
	</HEAD>
	<BODY id="bodMain">
   ...
   <td class="c">
       ...
       <td class="n" rowspan="2">
           ...
           <tr class="m">
		    ...
		    <a href="/web/20050916042206/http://toolbar.msn.com/desktop/results.aspx" title="16 Sep 2005">SEP</a>
		
		</td>
		<td class="c" id="displayMonthEl" title="You are here: 23:27:28 Oct 31, 2005">OCT</td>
		<td class="f" nowrap="nowrap">
           ...
           <tr class="d">
               <td class="b" nowrap="nowrap">
                   ...
                   <a href="/web/20051031090100/http://toolbar.msn.com/desktop/results.aspx?" title="9:01:00 Oct 31, 2005"><img src="/static/images/toolbar/wm_tb_prv_on.png" alt="Previous capture" width="14" height="16" border="0" /></a>
               
               </td>
               <td class="c" id="displayDayEl" style="width:34px;font-size:24px;" title="You are here: 23:27:28 Oct 31, 2005">31</td>
	       <td class="f" nowrap="nowrap">
               
		   <a href="/web/20051101092733/http://toolbar.msn.com/desktop/results.aspx?" title="9:27:33 Nov 1, 2005"><img src="/static/images/toolbar/wm_tb_nxt_on.png" alt="Next capture" width="14" height="16" border="0" /></a>
	       ...
	       <td class="b" nowrap="nowrap">
               ...
               <td class="c" id="displayYearEl" title="You are here: 23:27:28 Oct 31, 2005">2005</td>
	       <td class="f" nowrap="nowrap">
       ...
       <tr>
       <td class="s">
           <a class="t" href="/web/20051031232728*/http://toolbar.msn.com/desktop/results.aspx" title="See a list of every capture for this URL">535 captures</a>
 ...
 <!--Header-->
	...
	if(SniffBrowser() == "IE5up")
	{
		...
		else
		{
			...
			{
				self.location = "/web/20051031232728/http://toolbar.msn.com/desktop/results.aspx?FORM=PCHP&q=%20";
			}		
		}	
		...
		<div id="headwrapper"><script>var sHeaderShort = "Return to web results";var sHeaderLong = "Return to web results for %d";var sDesktopShort = "You need MSN Search Toolbar with Windows Desktop Search to search your desktop.";var sDesktopLong = "You need MSN Search Toolbar with Windows Desktop Search to search your desktop for %d.";var sDocumentsShort = "Find images, music files and documents.";var sDocumentsLong = "Find images, music files and documents relating to: %d.";var sMessagesShort = "Quickly find e-mail messages.";var sMessagesLong = "Quickly find e-mail messages including the words: %d.";</script>
			<div id="head">
				<div id="head_left_column"><a href="/web/20051031232728/http://search.msn.com/results.aspx?%d&amp;from=deskca" id="hplHLink">
						<script>																																																				
				...
				<div id="head_right_column"><span id="spnCobrandedLogoJavascript"><a href="/web/20051031232728/http://g.msn.com/8SEENUS/MSNLogohdr_all" id="hplLogoLink">
							<SCRIPT type="text/javascript">logoImg("/web/20051031232728/http://sc.msn.com");</SCRIPT>
							<noscript>
		...
		else
		{
			...
			<div id="column_right"><IMG alt="" src="../support/images/cap_green_top.gif"><br>
				<div id="padding">
					...
					<a href="/web/20051031232728/http://g.msn.com/8SEURL/enusDownloadSuiteURLbdy_results" id="hplDownload"><img src="../Support/Cultures/Downloadnow_free.gif" id="imgDownLoad" alt="Download Toolbar Now - FREE" border="0" /> </a>
					<br>
					<a href="/web/20051031232728/http://g.msn.com/8SEENUS020100/Results_AllMarkets" id="hplInternationalVersions" class="instructional" style="FONT-SIZE: 85%">International Versions</a>
					...
					function work()
					{
						self.location = "/web/20051031232728/http://g.yupimsn.com/8SEURL/esus";
					}																
					</SCRIPT>
					...
					<ul>
						<li>
							<a href="/web/20051031232728/http://g.msn.com/8SEENUS020100/OSSysReqbdy_results" id="hplMicrosoftWindowsXPServer20032000" style="FONT-SIZE: 85%">Microsoft Windows XP/Server 2003/2000</a>
						<li>
							<a href="/web/20051031232728/http://g.msn.com/8SEENUS020100/IESysReqbdy_results" id="hplMicrosoftInternetExplorer501Or" style="FONT-SIZE: 85%">Microsoft Internet Explorer 5.01 or later</a>
						<li>
...
<center>
	<div style="CLEAR:both" id="wrpHeadFoot">
			...
			<span id="ftMain_spnSearchFooter">
				...
				<div id="LegalFooter">
					<SPAN id="ftMain_spnCopyright">©2005 Microsoft Corporation</SPAN> <SPAN style="PADDING-RIGHT: 0px; PADDING-LEFT: 12px; PADDING-BOTTOM: 0px; PADDING-TOP: 0px">
						<a href="/web/20051031232728/http://g.msn.com/8SEENUS020100/LegalFooter1_all" id="ftMain_hplLegal1">Legal</a>
					</SPAN><SPAN style="PADDING-RIGHT: 0px; PADDING-LEFT: 12px; PADDING-BOTTOM: 0px; PADDING-TOP: 0px">
						<a href="/web/20051031232728/http://g.msn.com/8SEENUS020100/LegalFooter2_all" id="ftMain_hplLegal2">MSN Privacy</a> </SPAN>
				</div>
			</span>
		</div>
	</div>
		...
		<br>
		<script>
	var sSource = '/web/20051031232728/http://s.msn.com/c.gif?PS=83881&DI=2883&CY=en-us&LS=SMC&TP=/web/20051031232728/http://toolbar.msn.com/desktop/results.aspx&RF=' + parent.document.referrer;				
...
<!--
     FILE ARCHIVED ON 23:27:28 Oct 31, 2005 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 6:28:51 Jan 6, 2015.
