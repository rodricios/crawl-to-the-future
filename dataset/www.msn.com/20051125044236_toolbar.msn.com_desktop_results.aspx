...
<script type="text/javascript">archive_analytics.values.server_name="wwwb-app11.us.archive.org";archive_analytics.values.server_ms=1854;</script>
...
<SCRIPT language=javascript src=../Support/hdr35.js?v=2 type=text/javascript></SCRIPT>				
		...
		<script>function TellMeMore(){self.location = '/web/20051125054750/http://g.msn.com/8SEENUS020100/SuiteHomeBdy_results'};</script>
		<SCRIPT>function OpenSys(){window.open('/web/20051125054750/http://g.msn.com/8SEENUS020100/TBarHome_MoreSysReq','','height=570,width=385,toolbar=0,status=0,menubar=0,resizable=0,top=0');}</SCRIPT>
	</HEAD>
	<BODY id="bodMain">
   ...
   <td class="c">
       ...
       <td class="n" rowspan="2">
           ...
           <tr class="m">
		    ...
		    <a href="/web/20051024081252/http://toolbar.msn.com/desktop/results.aspx?" title="24 Oct 2005">OCT</a>
		
		</td>
		<td class="c" id="displayMonthEl" title="You are here: 5:47:50 Nov 25, 2005">NOV</td>
		<td class="f" nowrap="nowrap">
		
		    <a href="/web/20051227053452/http://toolbar.msn.com/desktop/results.aspx?" title="27 Dec 2005"><strong>DEC</strong></a>
           ...
           <tr class="d">
               <td class="b" nowrap="nowrap">
                   ...
                   <a href="/web/20051124232214/http://toolbar.msn.com/desktop/results.aspx?" title="23:22:14 Nov 24, 2005"><img src="/static/images/toolbar/wm_tb_prv_on.png" alt="Previous capture" width="14" height="16" border="0" /></a>
               
               </td>
               <td class="c" id="displayDayEl" style="width:34px;font-size:24px;" title="You are here: 5:47:50 Nov 25, 2005">25</td>
	       <td class="f" nowrap="nowrap">
               
		   <a href="/web/20051125073120/http://toolbar.msn.com/desktop/results.aspx?" title="7:31:20 Nov 25, 2005"><img src="/static/images/toolbar/wm_tb_nxt_on.png" alt="Next capture" width="14" height="16" border="0" /></a>
	       ...
	       <td class="b" nowrap="nowrap">
               ...
               <td class="c" id="displayYearEl" title="You are here: 5:47:50 Nov 25, 2005">2005</td>
	       <td class="f" nowrap="nowrap">
               
	           <a href="/web/20061128044621/http://toolbar.msn.com/desktop/results.aspx" title="28 Nov 2006"><strong>2006</strong></a>
       ...
       <tr>
       <td class="s">
           <a class="t" href="/web/20051125054750*/http://toolbar.msn.com/desktop/results.aspx" title="See a list of every capture for this URL">535 captures</a>
	...
	if(SniffBrowser() == "IE5up")
	{
		...
		if (!bToolbar26OrGreater)
		{
			...
			else
			{
				...
				{
					self.location = "/web/20051125054750/http://toolbar.msn.com/desktop/results.aspx?FORM=PCHP&q=%20";
				}		
			}
		}
		...
		<div id="headwrapper"><script>var sHeaderShort = "Return to web results";var sHeaderLong = "Return to web results for %d";var sDesktopShort = "You need MSN Search Toolbar with Windows Desktop Search to search your desktop.";var sDesktopLong = "You need MSN Search Toolbar with Windows Desktop Search to search your desktop for %d.";var sDocumentsShort = "Find images, music files and documents.";var sDocumentsLong = "Find images, music files and documents relating to: %d.";var sMessagesShort = "Quickly find e-mail messages.";var sMessagesLong = "Quickly find e-mail messages including the words: %d.";</script>
			<div id="head">
				<div id="head_left_column"><a href="/web/20051125054750/http://search.msn.com/results.aspx?%d&amp;from=deskca" id="hplHLink">
						<script>																																																				
				...
				<div id="head_right_column"><span id="spnCobrandedLogoJavascript"><a href="/web/20051125054750/http://g.msn.com/8SEENUS020100/MSNLogohdr_all" id="hplLogoLink">
							<SCRIPT type="text/javascript">logoImg("/web/20051125054750/http://sc.msn.com");</SCRIPT>
							<noscript>
		...
		else
		{
			...
			<div id="column_right"><IMG alt="" src="../support/images/cap_green_top.gif"><br>
				<div id="padding">
					...
					<a href="/web/20051125054750/http://g.msn.com/8SEURL/enusDownloadSuiteURLbdy_results" id="hplDownload"><img src="../Support/Cultures/Downloadnow_free.gif" id="imgDownLoad" alt="Download Toolbar Now - FREE" border="0" /> </a>
					<br>
					<a href="/web/20051125054750/http://g.msn.com/8SEENUS020100/Results_AllMarkets" id="hplInternationalVersions" class="instructional" style="FONT-SIZE: 85%">International Versions</a>
					...
					function work()
					{
						self.location = "/web/20051125054750/http://g.yupimsn.com/8SEURL/esus";
					}																
					</SCRIPT>
					...
					<ul>
						<li>
							<a href="/web/20051125054750/http://g.msn.com/8SEENUS020100/OSSysReqbdy_results" id="hplMicrosoftWindowsXPServer20032000" style="FONT-SIZE: 85%">Microsoft Windows XP/Server 2003/2000</a>
						<li>
							<a href="/web/20051125054750/http://g.msn.com/8SEENUS020100/IESysReqbdy_results" id="hplMicrosoftInternetExplorer501Or" style="FONT-SIZE: 85%">Microsoft Internet Explorer 5.01 or later</a>
						<li>
...
<center>
	<div style="CLEAR:both" id="wrpHeadFoot">
			...
			<span id="ftMain_spnSearchFooter">
				...
				<div id="LegalFooter">
					<SPAN id="ftMain_spnCopyright">&#169;2005 Microsoft.</SPAN> <SPAN style="PADDING-RIGHT: 0px; PADDING-LEFT: 12px; PADDING-BOTTOM: 0px; PADDING-TOP: 0px">
						<a href="/web/20051125054750/http://g.msn.com/8SEENUS020100/LegalFooter1_all" id="ftMain_hplLegal1">Legal</a>
					</SPAN><SPAN style="PADDING-RIGHT: 0px; PADDING-LEFT: 12px; PADDING-BOTTOM: 0px; PADDING-TOP: 0px">
						<a href="/web/20051125054750/http://g.msn.com/8SEENUS020100/LegalFooter2_all" id="ftMain_hplLegal2">MSN Privacy</a> </SPAN>
				</div>
			</span>
		</div>
	</div>
		...
		<br>
		<script>
	var sSource = '/web/20051125054750/http://s.msn.com/c.gif?PS=83881&DI=2883&CY=en-us&LS=SMC&TP=/web/20051125054750/http://toolbar.msn.com/desktop/results.aspx&RF=' + parent.document.referrer;				
...
<!--
     FILE ARCHIVED ON 5:47:50 Nov 25, 2005 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 6:38:31 Jan 6, 2015.
